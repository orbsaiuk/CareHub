...
export async function POST(request) {
  ...
  try {
    ...
    // Convert businessType string to proper reference
    const businessTypeRef = await ensureBusinessTypeRef(businessType, tenantType);
      ...
      registrationNumber:
        typeof registrationNumber === "number"
          ...
          : registrationNumber
            ...
            : null,
      socialLinks:
        typeof socialLinks === "object" && !Array.isArray(socialLinks)
          ? {
    ...
    // Only add businessType if we have a valid reference
    if (businessTypeRef) {
      doc.businessType = businessTypeRef;
    }
