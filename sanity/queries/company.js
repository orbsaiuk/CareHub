...
*[_type == "company" && tenantType == $tenantType && tenantId == $tenantId][0]{
  ...
  "reviews": *[_type=="review" && tenantType == $tenantType && tenantId == $tenantId && company._ref == ^._id] | order(createdAt desc)[0...50]{
    _id, title, rating, content, authorName, authorClerkId, createdAt, reply
  }
}`;
...
export const COMPANY_BY_TENANT_ID_FOR_EMAIL_QUERY = `
...
// Get company ID by tenant ID (minimal query)
export const COMPANY_ID_BY_TENANT_ID_QUERY = `
*[_type == "company" && tenantId == $tenantId][0]{ _id }`;
