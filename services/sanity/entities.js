...
import { ensureBusinessTypeRef } from "./businessTypes.js";
...
export async function createCompanyDocument(doc, tenantId) {
  ...
  // Ensure we have proper businessType reference
    ...
    registrationNumber:
      typeof doc.registrationNumber === "number"
        ...
        : doc.registrationNumber
          ...
          : null,
    socialLinks:
      typeof doc.socialLinks === "object" && !Array.isArray(doc.socialLinks)
        ? {
            facebook: doc.socialLinks.facebook || null,
            instagram: doc.socialLinks.instagram || null,
            snapchat: doc.socialLinks.snapchat || null,
          }
        : null,
